...
def process_choice(choice):
    ...
    match choice:
        ...
        case 6:
            ...
            input("Press enter to continue")
        case 7: 
            print("I like the color of the text and the functionalities is so "
                  + "engaging - Piadozo")
            input("Press enter to continue")
        case 0:
            pass
...
def display_goal():
    print("Goals")
    print("1. Achieve stability across all aspects of life, including "
          + "financial security and personal growth.")
    print("2. Maintain a healthy body and mind to ensure long-term well-being.")
    print("3. Provide for and support my family, ensuring their happiness "
          + "and security.")
    ...
    print("7. Build a joyful and supportive family environment, where love "
          +"and happiness thrive.")
    input("Press enter to continue")

def do_guessing_game():
    print("Guessing Game")
